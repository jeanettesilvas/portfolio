const socials = [
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/jeanetteasilvas",
    icon: (
...
export function Footer() {
  return (
    <footer className="px-8 md:px-12 py-8 flex items-center justify-between border-t border-border mt-auto">
      <p className="text-xs text-muted-foreground">
        © {new Date().getFullYear()} Jeanette Silvas
      </p>
